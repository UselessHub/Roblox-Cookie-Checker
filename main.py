...
@client.event
async def on_ready():
  print('bot is online') #print when bot is online

@client.command() #command
async def look(ctx, cookie):
  ...
  if check.status_code ==200: #if valid..
    ...
    e.set_author(name='Bot made by Useless#9999')
    ...
    e.set_footer(text='Bot Made By Useless#6537')
    ...
    e = discord.Embed(title='**❌ Cookie is Dead Sorry You Poor Nub | Better Luck Next Time ❌**',color=0xff0000)
    await ctx.send(embed=e)
